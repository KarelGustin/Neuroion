...
Deploy Neuroion on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.com/deploy/neuroionbot-railway-template" target="_blank" rel="noreferrer">
  Deploy on Railway
</a>
...
- `https://<your-railway-domain>/neuroion` — Control UI

## What you get

- Hosted Neuroion Gateway + Control UI
...
- `NEUROION_STATE_DIR=/data/.neuroion` (recommended)
- `NEUROION_WORKSPACE_DIR=/data/workspace` (recommended)
- `NEUROION_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your Neuroion state + workspace so you can migrate to another host without losing config or memory.
