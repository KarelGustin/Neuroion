...
summary: "`neuroion skills` 的 CLI 参考（列出/信息/检查）和 skill 资格"
title: skills
x-i18n:
...
- NeuroionHub 安装：[NeuroionHub](/tools/neuroionhub)

## 命令

```bash
neuroion skills list
neuroion skills list --eligible
neuroion skills info <name>
neuroion skills check
```
