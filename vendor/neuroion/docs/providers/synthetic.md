---
summary: "Use Synthetic's Anthropic-compatible API in Neuroion"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Neuroion registers it as the
...
Note: Neuroion's Anthropic client appends `/v1` to the base URL, so use
