---
summary: "Use Qwen OAuth (free tier) in Neuroion"
read_when:
  - You want to use Qwen with Neuroion
...
If you already logged in with the Qwen Code CLI, Neuroion will sync credentials
