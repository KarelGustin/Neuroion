---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Neuroion"
read_when:
  - You want Xiaomi MiMo models in Neuroion
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Neuroion uses
