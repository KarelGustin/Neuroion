...
You can point Neuroion at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Neuroion
...
- [Anthropic provider](/providers/anthropic) - Native Neuroion integration with Claude setup-token or API keys
