...
This guide summarizes a sane workflow for working on the pi integration in Neuroion.
...
- Trigger the agent directly:
  - `pnpm neuroion agent --message "Hello" --thinking low`
...
State lives under the Neuroion state directory. Default is `~/.neuroion`. If `NEUROION_STATE_DIR` is set, use that directory instead.

To reset everything:

- `neuroion.json` for config
...
- https://docs.neuroion.ai/testing
- https://docs.neuroion.ai/start/getting-started
