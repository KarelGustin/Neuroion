...
read_when:
  - You want Neuroion to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables Neuroion to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`neuroion onboard`) and `neuroion channels add` list optional channel plugins.
...
```bash
neuroion plugins install @neuroion/nostr
```

Use a local checkout (dev workflows):

```bash
neuroion plugins install --link <path-to-neuroion>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "neuroion",
        "displayName": "Neuroion",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "neuroion@example.com",
        "lud16": "neuroion@example.com"
      }
    }
  }
}
