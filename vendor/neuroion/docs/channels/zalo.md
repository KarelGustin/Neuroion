...
- Install via CLI: `neuroion plugins install @neuroion/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `neuroion plugins install ./extensions/zalo`
   - From npm (if published): `neuroion plugins install @neuroion/zalo`
...
- Approve via:
  - `neuroion pairing list zalo`
  - `neuroion pairing approve zalo <CODE>`
...
- Example: `neuroion message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `neuroion channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `neuroion logs --follow`
