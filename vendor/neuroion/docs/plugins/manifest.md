...
read_when:
  - You are building a Neuroion plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (neuroion.plugin.json)

Every plugin **must** ship a `neuroion.plugin.json` file in the **plugin root**.
Neuroion uses this manifest to validate configuration **without executing plugin
