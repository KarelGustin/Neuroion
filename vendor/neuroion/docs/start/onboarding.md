---
summary: "First-run onboarding flow for Neuroion (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Neuroion">
...
<Step title="CLI">
  ...
  The app can install the global `neuroion` CLI via npm/pnpm so terminal
