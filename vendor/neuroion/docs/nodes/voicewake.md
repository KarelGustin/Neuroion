...
Neuroion treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.neuroion/settings/voicewake.json`

Shape:

```json
{ "triggers": ["neuroion", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
