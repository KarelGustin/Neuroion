...
- **gateway host** → `neuroion` process on the gateway machine
...
`~/.neuroion/exec-approvals.json` directly.

CLI: `neuroion approvals` supports gateway or node editing (see [Approvals CLI](/cli/approvals)).
