...
Neuroion has two separate “streaming” layers:
...
When block streaming is enabled, Neuroion can **merge consecutive block chunks**
...
When draft streaming is active, Neuroion disables block streaming for that reply to avoid double-streaming.
