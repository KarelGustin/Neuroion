...
Neuroion treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.

## Beginner intro (2 minutes)

Neuroion “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Neuroion can see that group and respond there.
...
Translation: allowlisted senders can trigger Neuroion by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@neuroion", "neuroion", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
