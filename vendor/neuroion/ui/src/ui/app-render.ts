...
import { NeuroionApp } from "./app.ts";
        ...
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src="${logoHref}" alt="Neuroion" />
            </div>
            <div class="brand-text">
              <div class="brand-title">NEUROION</div>
          ...
          state.tab === "overview"
            ? renderOverview({
                ...
                onSessionKeyChange: (next) => {
                  ...
                  state.chatMessage = "";
                  (state as unknown as NeuroionApp).resetToolStream();
                  state.applySettings({
                    ...state.settings,
                    sessionKey: next,
          ...
          state.tab === "chat"
            ? renderChat({
                ...
                onSessionKeyChange: (next) => {
                  ...
                  (state as unknown as NeuroionApp).chatStreamStartedAt = null;
                  state.chatQueue = [];
                  (state as unknown as NeuroionApp).resetToolStream();
                  (state as unknown as NeuroionApp).resetChatScroll();
                  state.applySettings({
                    ...state.settings,
                    sessionKey: next,
                    lastActiveSessionKey: next,
                ...
                onChatScroll: (event) => (state as unknown as NeuroionApp).handleChatScroll(event),
                onDraftChange: (next) => (state.chatMessage = next),
                attachments: state.chatAttachments,
                onAttachmentsChange: (next) => (state.chatAttachments = next),
                onSend: () => (state as unknown as NeuroionApp).handleSendChat(),
                canAbort: Boolean(state.chatRunId),
                onAbort: () => void (state as unknown as NeuroionApp).handleAbortChat(),
                onQueueRemove: (id) => (state as unknown as NeuroionApp).removeQueuedMessage(id),
                onNewSession: () =>
                  (state as unknown as NeuroionApp).handleSendChat("/new", { restoreDraft: true }),
                showNewMessages: state.chatNewMessagesBelow,
                onScrollToBottom: () => state.scrollToBottom(),
                // Sidebar props for tool output viewing
                sidebarOpen: (state as unknown as NeuroionApp).sidebarOpen,
                sidebarContent: (state as unknown as NeuroionApp).sidebarContent,
                sidebarError: (state as unknown as NeuroionApp).sidebarError,
                splitRatio: (state as unknown as NeuroionApp).splitRatio,
                onOpenSidebar: (content: string) =>
                  (state as unknown as NeuroionApp).handleOpenSidebar(content),
                onCloseSidebar: () => (state as unknown as NeuroionApp).handleCloseSidebar(),
                onSplitRatioChange: (ratio: number) =>
                  (state as unknown as NeuroionApp).handleSplitRatioChange(ratio),
        ...
        ${
          state.tab === "config"
            ? renderConfig({
                ...
                searchQuery: (state as unknown as NeuroionApp).configSearchQuery,
                activeSection: (state as unknown as NeuroionApp).configActiveSection,
                activeSubsection: (state as unknown as NeuroionApp).configActiveSubsection,
                onRawChange: (next) => {
                  state.configRaw = next;
                },
                onFormModeChange: (mode) => (state.configFormMode = mode),
                onFormPatch: (path, value) =>
                  updateConfigFormValue(state as unknown as NeuroionApp, path, value),
                onSearchChange: (query) =>
                  ((state as unknown as NeuroionApp).configSearchQuery = query),
                onSectionChange: (section) => {
                  (state as unknown as NeuroionApp).configActiveSection = section;
                  (state as unknown as NeuroionApp).configActiveSubsection = null;
                },
                onSubsectionChange: (section) =>
                  ((state as unknown as NeuroionApp).configActiveSubsection = section),
                onReload: () => loadConfig(state as unknown as NeuroionApp),
                onSave: () => saveConfig(state as unknown as NeuroionApp),
                onApply: () => applyConfig(state as unknown as NeuroionApp),
                onUpdate: () => runUpdate(state as unknown as NeuroionApp),
              })
            : nothing
        }
          ...
          state.tab === "logs"
            ? renderLogs({
                ...
                onExport: (lines, label) =>
                  (state as unknown as NeuroionApp).exportLogs(lines, label),
                onScroll: (event) => (state as unknown as NeuroionApp).handleLogsScroll(event),
              })
            : nothing
        }
      </main>
