...
declare global {
  interface Window {
    __NEUROION_ASSISTANT_NAME__?: string;
    __NEUROION_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__NEUROION_ASSISTANT_NAME__,
    avatar: window.__NEUROION_ASSISTANT_AVATAR__,
  });
}
