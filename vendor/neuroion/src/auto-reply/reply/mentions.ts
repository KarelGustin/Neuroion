...
function resolveMentionPatterns(cfg: NeuroionConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: NeuroionConfig | undefined, agentId?: string): RegExp[] {
