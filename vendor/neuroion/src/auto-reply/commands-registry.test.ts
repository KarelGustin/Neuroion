...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@neuroion", { botUsername: "neuroion" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@neuroion args", {
        botUsername: "neuroion",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@neuroion: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "neuroion" })).toBe(
      "/help@otherbot",
    );
  });
