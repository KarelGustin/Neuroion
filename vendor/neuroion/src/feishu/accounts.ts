...
function mergeFeishuAccountConfig(cfg: NeuroionConfig, accountId: string): FeishuAccountConfig {
...
export function listFeishuAccountIds(cfg: NeuroionConfig): string[] {
...
export function resolveDefaultFeishuAccountId(cfg: NeuroionConfig): string {
