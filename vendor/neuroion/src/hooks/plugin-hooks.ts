...
import type { NeuroionPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: NeuroionPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: NeuroionPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
