...
import type { NeuroionConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: NeuroionConfig, agentId: string) {
  try {
