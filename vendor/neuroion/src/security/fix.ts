...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof NeuroionConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: NeuroionConfig; env: NodeJS.ProcessEnv }): {
  cfg: NeuroionConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
