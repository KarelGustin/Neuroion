...
import type { GatewayBindMode, GatewayTailscaleMode, NeuroionConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.neuroion.ai/gateway/tailscale", "https://docs.neuroion.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
