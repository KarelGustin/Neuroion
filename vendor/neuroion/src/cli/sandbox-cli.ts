...
const SANDBOX_EXAMPLES = {
  main: [
    ["neuroion sandbox list", "List all sandbox containers."],
    ["neuroion sandbox list --browser", "List only browser containers."],
    ["neuroion sandbox recreate --all", "Recreate all containers."],
    ["neuroion sandbox recreate --session main", "Recreate a specific session."],
    ["neuroion sandbox recreate --agent mybot", "Recreate agent containers."],
    ["neuroion sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["neuroion sandbox list", "List all sandbox containers."],
    ["neuroion sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["neuroion sandbox recreate --all", "Recreate all containers."],
    ["neuroion sandbox recreate --session main", "Recreate a specific session."],
    ["neuroion sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["neuroion sandbox recreate --browser --all", "Recreate only browser containers."],
    ["neuroion sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["neuroion sandbox explain", "Show effective sandbox config."],
    ["neuroion sandbox explain --session agent:main:main", "Explain a specific session."],
    ["neuroion sandbox explain --agent work", "Explain an agent sandbox."],
    ["neuroion sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.neuroion.ai/cli/sandbox")}\n`,
    )
    .action(() => {
