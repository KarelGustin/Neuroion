...
export const DEFAULT_LOG_DIR = "/tmp/neuroion";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "neuroion.log"); // legacy single-file path

const LOG_PREFIX = "neuroion";
...
function resolveSettings(): ResolvedSettings {
  let cfg: NeuroionConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => NeuroionConfig;
      };
