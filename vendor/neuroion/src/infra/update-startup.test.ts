...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "neuroion-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveNeuroionPackageRoot } = await import("./neuroion-root.js");
    ...
    vi.mocked(resolveNeuroionPackageRoot).mockResolvedValue("/opt/neuroion");
