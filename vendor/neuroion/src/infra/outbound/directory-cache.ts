...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: NeuroionConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: NeuroionConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: NeuroionConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: NeuroionConfig): void {
