...
import type { NeuroionPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverNeuroionPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, NeuroionPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["NEUROION_PLUGIN_CATALOG_PATHS", "NEUROION_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<NeuroionPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: NeuroionPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: NeuroionPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverNeuroionPlugins({ workspaceDir: options.workspaceDir });
