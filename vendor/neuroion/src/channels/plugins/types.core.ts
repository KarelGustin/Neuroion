...
export type ChannelAgentToolFactory = (params: { cfg?: NeuroionConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: NeuroionConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: NeuroionConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: NeuroionConfig }) => boolean;
  supportsCards?: (params: { cfg: NeuroionConfig }) => boolean;
