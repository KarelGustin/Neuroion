...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @neuroion/voice-call -> voice-call).
...
export function discoverNeuroionPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".neuroion", "extensions")];
