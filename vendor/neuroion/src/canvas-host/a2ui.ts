...
export const A2UI_PATH = "/__neuroion__/a2ui";

export const CANVAS_HOST_PATH = "/__neuroion__/canvas";

export const CANVAS_WS_PATH = "/__neuroion__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.neuroionCanvasA2UIAction.postMessage(...)
  // - Android: window.neuroionCanvasA2UIAction.postMessage(...)
  const handlerNames = ["neuroionCanvasA2UIAction"];
  ...
  globalThis.Neuroion = globalThis.Neuroion ?? {};
  globalThis.Neuroion.postMessage = postToNode;
  globalThis.Neuroion.sendUserAction = sendUserAction;
  globalThis.neuroionPostMessage = postToNode;
  globalThis.neuroionSendUserAction = sendUserAction;
