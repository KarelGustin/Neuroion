...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveNeuroionAgentDir() returns mainAgentDir
    process.env.NEUROION_STATE_DIR = tmpDir;
    process.env.NEUROION_AGENT_DIR = mainAgentDir;
