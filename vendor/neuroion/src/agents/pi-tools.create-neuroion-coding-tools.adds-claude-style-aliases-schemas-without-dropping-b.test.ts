...
describe("createNeuroionCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createNeuroionCodingTools({
      config,
    ...
    const anthropicTools = createNeuroionCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createNeuroionCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createNeuroionCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
