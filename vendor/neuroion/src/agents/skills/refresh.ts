...
function resolveWatchPaths(workspaceDir: string, config?: NeuroionConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: NeuroionConfig }) {
