...
function resolveAvatarSource(cfg: NeuroionConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: NeuroionConfig, agentId: string): AgentAvatarResolution {
