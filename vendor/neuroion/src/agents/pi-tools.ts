...
function resolveExecConfig(cfg: NeuroionConfig | undefined) {
...
export function createNeuroionCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      return [createNeuroionReadTool(freshReadTool)];
    }
