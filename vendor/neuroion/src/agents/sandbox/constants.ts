...
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".neuroion", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "neuroion-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "neuroion-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "neuroion-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "neuroion-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "neuroion-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR ?? path.join(os.homedir(), ".neuroion");
