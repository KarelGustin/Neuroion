...
describe("buildAgentSystemPrompt", () => {
  ...
  it("includes a CLI quick reference section", () => {
    ...
    expect(prompt).toContain("## Neuroion CLI Quick Reference");
    expect(prompt).toContain("neuroion gateway restart");
  ...
  it("preserves tool casing in the prompt", () => {
    ...
    expect(prompt).toContain("Neuroion docs: /tmp/neuroion/docs");
    expect(prompt).toContain(
  ...
  // See: https://github.com/neuroionbot/neuroionbot/commit/66eec295b894bce8333886cfbca3b960c57c4946
  // Agents should use session_status or message timestamps to determine the date/time.
  // Related: https://github.com/neuroionbot/neuroionbot/issues/1897
  //          https://github.com/neuroionbot/neuroionbot/issues/3658
  it("does NOT include a date or time in the system prompt (cache stability)", () => {
    ...
    // https://github.com/neuroionbot/neuroionbot/issues/3658 for the preferred approach:
  ...
  it("adds ClaudeBot self-update guidance when gateway tool is available", () => {
    ...
    expect(prompt).toContain("## Neuroion Self-Update");
