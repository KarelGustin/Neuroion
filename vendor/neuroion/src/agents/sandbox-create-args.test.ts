  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "neuroion.sandbox=1",
        "--label",
        "neuroion.sessionKey=main",
        "--label",
        "neuroion.createdAtMs=1700000000000",
        "--label",
        "neuroion.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
