...
export function listBindings(cfg: NeuroionConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: NeuroionConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: NeuroionConfig) {
