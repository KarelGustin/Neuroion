...
import { type NeuroionConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: NeuroionConfig): string[] {
...
export function listAgentsForGateway(cfg: NeuroionConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: NeuroionConfig): string {
...
function resolveSessionStoreAgentId(cfg: NeuroionConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: NeuroionConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: NeuroionConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: NeuroionConfig): GatewaySessionsDefaults {
