 ...
 *
 * @see https://github.com/neuroionbot/neuroionbot/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an NeuroionConfig.
 */
export function timestampOptsFromConfig(cfg: NeuroionConfig): TimestampInjectionOptions {
  return {
