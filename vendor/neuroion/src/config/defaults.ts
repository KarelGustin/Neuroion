...
function resolveAnthropicDefaultAuthMode(cfg: NeuroionConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: NeuroionConfig): NeuroionConfig {
...
export function applyTalkApiKey(config: NeuroionConfig): NeuroionConfig {
...
export function applyModelDefaults(cfg: NeuroionConfig): NeuroionConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: NeuroionConfig): NeuroionConfig {
...
export function applyLoggingDefaults(cfg: NeuroionConfig): NeuroionConfig {
...
export function applyContextPruningDefaults(cfg: NeuroionConfig): NeuroionConfig {
...
export function applyCompactionDefaults(cfg: NeuroionConfig): NeuroionConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
