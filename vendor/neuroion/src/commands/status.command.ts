...
export async function statusCommand(
  ...
  runtime.log(theme.heading("Neuroion status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("neuroion security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("neuroion security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.neuroion.ai/faq");
  runtime.log("Troubleshooting: https://docs.neuroion.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("neuroion status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("neuroion logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("neuroion status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("neuroion gateway probe")}`);
  }
}
