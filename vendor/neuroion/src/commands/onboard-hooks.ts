...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.neuroion.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("neuroion hooks list")}`,
      `  ${formatCliCommand("neuroion hooks enable <name>")}`,
      `  ${formatCliCommand("neuroion hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
