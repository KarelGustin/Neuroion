...
const ensureNeuroionModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveNeuroionAgentDir = vi.fn().mockReturnValue("/tmp/neuroion-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/neuroion-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureNeuroionModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveNeuroionAgentDir,
}));
