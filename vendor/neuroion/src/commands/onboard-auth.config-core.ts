...
export function applyZaiConfig(cfg: NeuroionConfig): NeuroionConfig {
...
export function applyOpenrouterProviderConfig(cfg: NeuroionConfig): NeuroionConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: NeuroionConfig): NeuroionConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: NeuroionConfig): NeuroionConfig {
...
export function applyOpenrouterConfig(cfg: NeuroionConfig): NeuroionConfig {
...
export function applyMoonshotProviderConfig(cfg: NeuroionConfig): NeuroionConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: NeuroionConfig): NeuroionConfig {
...
export function applyMoonshotConfig(cfg: NeuroionConfig): NeuroionConfig {
...
export function applyMoonshotConfigCn(cfg: NeuroionConfig): NeuroionConfig {
...
export function applyKimiCodeProviderConfig(cfg: NeuroionConfig): NeuroionConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: NeuroionConfig): NeuroionConfig {
...
export function applySyntheticProviderConfig(cfg: NeuroionConfig): NeuroionConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: NeuroionConfig): NeuroionConfig {
...
export function applyXiaomiProviderConfig(cfg: NeuroionConfig): NeuroionConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: NeuroionConfig): NeuroionConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: NeuroionConfig): NeuroionConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: NeuroionConfig): NeuroionConfig {
