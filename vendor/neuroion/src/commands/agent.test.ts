...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "neuroion-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<NeuroionConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<NeuroionConfig["telegram"]>>,
