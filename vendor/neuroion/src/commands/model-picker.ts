...
function resolveConfiguredModelRaw(cfg: NeuroionConfig): string {
...
function resolveConfiguredModelKeys(cfg: NeuroionConfig): string[] {
...
export function applyPrimaryModel(cfg: NeuroionConfig, model: string): NeuroionConfig {
...
export function applyModelAllowlist(cfg: NeuroionConfig, models: string[]): NeuroionConfig {
  const defaults = cfg.agents?.defaults;
