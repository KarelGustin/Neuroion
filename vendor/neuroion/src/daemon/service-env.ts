...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.NEUROION_STATE_DIR;
  const configPath = env.NEUROION_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    NEUROION_PROFILE: profile,
    NEUROION_STATE_DIR: stateDir,
    NEUROION_CONFIG_PATH: configPath,
    NEUROION_GATEWAY_PORT: String(port),
    NEUROION_GATEWAY_TOKEN: token,
    NEUROION_LAUNCHD_LABEL: resolvedLaunchdLabel,
    NEUROION_SYSTEMD_UNIT: systemdUnit,
    NEUROION_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    NEUROION_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    NEUROION_STATE_DIR: stateDir,
    NEUROION_CONFIG_PATH: configPath,
    NEUROION_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    NEUROION_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    NEUROION_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    NEUROION_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    NEUROION_LOG_PREFIX: "node",
    NEUROION_SERVICE_MARKER: NODE_SERVICE_MARKER,
    NEUROION_SERVICE_KIND: NODE_SERVICE_KIND,
    NEUROION_SERVICE_VERSION: VERSION,
  };
}
