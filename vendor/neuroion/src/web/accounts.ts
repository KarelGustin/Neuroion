...
function listConfiguredAccountIds(cfg: NeuroionConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: NeuroionConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: NeuroionConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: NeuroionConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: NeuroionConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: NeuroionConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: NeuroionConfig): ResolvedWhatsAppAccount[] {
