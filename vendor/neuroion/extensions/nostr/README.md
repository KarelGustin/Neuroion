...
Nostr DM channel plugin for Neuroion using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Neuroion. It enables your bot to:
...
# Configure neuroion to use local relay
