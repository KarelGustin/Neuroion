...
export function listZalouserAccountIds(cfg: NeuroionConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: NeuroionConfig): string {
...
function mergeZalouserAccountConfig(cfg: NeuroionConfig, accountId: string): ZalouserAccountConfig {
