...
import type { ReplyPayload, NeuroionConfig } from "neuroion/plugin-sdk";
import { createReplyPrefixOptions } from "neuroion/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as NeuroionConfig;
