...
export function listGoogleChatAccountIds(cfg: NeuroionConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: NeuroionConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: NeuroionConfig): ResolvedGoogleChatAccount[] {
