...
export function listBlueBubblesAccountIds(cfg: NeuroionConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: NeuroionConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: NeuroionConfig): ResolvedBlueBubblesAccount[] {
