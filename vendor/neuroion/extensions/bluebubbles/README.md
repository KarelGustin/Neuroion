...
This directory contains the **BlueBubbles external channel plugin** for Neuroion.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `neuroion/plugin-sdk` helpers.
