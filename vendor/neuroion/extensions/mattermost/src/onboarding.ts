import type { ChannelOnboardingAdapter, NeuroionConfig, WizardPrompter } from "neuroion/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.neuroion.ai/channels/mattermost",
    ].join("\n"),
