...
export function listMattermostAccountIds(cfg: NeuroionConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: NeuroionConfig): string {
...
export function listEnabledMattermostAccounts(cfg: NeuroionConfig): ResolvedMattermostAccount[] {
