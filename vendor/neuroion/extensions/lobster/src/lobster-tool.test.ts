...
import type { NeuroionPluginApi, NeuroionPluginToolContext } from "../../../src/plugins/types.js";
import { createLobsterTool } from "./lobster-tool.js";

async function writeFakeLobsterScript(scriptBody: string, prefix = "neuroion-lobster-plugin-") {
...
function fakeApi(overrides: Partial<NeuroionPluginApi> = {}): NeuroionPluginApi {
  return {
    id: "lobster",
    name: "lobster",
    source: "test",
...
function fakeCtx(overrides: Partial<NeuroionPluginToolContext> = {}): NeuroionPluginToolContext {
  return {
    config: {},
    workspaceDir: "/tmp",
    agentDir: "/tmp",
...
describe("lobster plugin tool", () => {
  ...
  it("can be gated off in sandboxed contexts", async () => {
    const api = fakeApi();
    const factoryTool = (ctx: NeuroionPluginToolContext) => {
      if (ctx.sandboxed) {
        return null;
      }
