## Neuroion Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_neuroion-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm neuroion gateway --port 18789 --verbose
```
