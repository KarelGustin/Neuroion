...
final class ScreenController {
    ...
    /// Callback invoked when an neuroion:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = NeuroionKitResources.bundle
...
/// Handles navigation policy to intercept neuroion:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept neuroion:// deep links.
        if url.scheme?.lowercased() == "neuroion" {
