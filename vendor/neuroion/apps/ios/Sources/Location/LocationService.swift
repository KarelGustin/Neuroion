...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: NeuroionLocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: NeuroionLocationGetParams,
    ...
    private static func accuracyValue(_ accuracy: NeuroionLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
