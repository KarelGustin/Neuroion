...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = NeuroionLocationMode.off.rawValue
        ...
        NavigationStack {
            Form {
                ...
                Section("Screen") {
                    ...
                    Text("Keeps the screen awake while Neuroion is open.")
                        .font(.footnote)
                        .foregroundStyle(.secondary)
                }
            }
    ...
    private var locationMode: NeuroionLocationMode {
        NeuroionLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
