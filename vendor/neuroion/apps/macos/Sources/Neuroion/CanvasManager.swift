...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.neuroion", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Neuroion/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__neuroion__/a2ui/").absoluteString + "?platform=macos"
    }
