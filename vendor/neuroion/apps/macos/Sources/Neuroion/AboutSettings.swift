...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/neuroion/neuroion") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/neuroion/neuroion")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://neuroion.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "NeuroionBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "NeuroionBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "NeuroionGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "NeuroionGitCommit") as? String) ??
            "unknown"
    }
