...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .neuroionSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? NeuroionPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? NeuroionPaths.stateDirURL.path
...
extension Notification.Name {
    static let neuroionSelectSettingsTab = Notification.Name("neuroionSelectSettingsTab")
}
