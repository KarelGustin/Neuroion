...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.neuroion", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".neuroion/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.neuroionCommand(
            subcommand: "gateway",
