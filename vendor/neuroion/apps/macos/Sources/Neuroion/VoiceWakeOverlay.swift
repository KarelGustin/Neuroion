...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.neuroion", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Neuroion windows, but below the system’s pop-up menus.
