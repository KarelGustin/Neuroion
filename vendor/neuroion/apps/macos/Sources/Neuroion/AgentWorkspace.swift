...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.neuroion", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return NeuroionConfigFile.defaultWorkspaceURL() }
