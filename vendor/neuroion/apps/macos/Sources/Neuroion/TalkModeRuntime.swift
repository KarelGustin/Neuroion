...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.neuroion", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.neuroion", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [NeuroionChatMessage] = messages.compactMap { item in
