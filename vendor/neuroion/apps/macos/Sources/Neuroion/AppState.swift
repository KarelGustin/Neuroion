...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = NeuroionConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = NeuroionConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = NeuroionConfigFile.loadDict()
            ...
            NeuroionConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/neuroion"
        state.remoteCliPath = ""
        return state
    }
}
