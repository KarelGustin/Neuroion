...
enum UIStrings {
    static let welcomeTitle = "Welcome to Neuroion"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "neuroion.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: NeuroionOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: NeuroionChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g neuroion@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: NeuroionChatViewModel(
