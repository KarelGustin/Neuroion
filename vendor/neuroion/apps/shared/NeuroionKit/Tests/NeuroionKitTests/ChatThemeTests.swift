...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = NeuroionChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = NeuroionChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
