...
public typealias NeuroionPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias NeuroionPlatformImage = UIImage
#endif

public struct NeuroionChatUsageCost: Codable, Hashable, Sendable {
...
public struct NeuroionChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: NeuroionChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(NeuroionChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct NeuroionChatMessageContent: Codable, Hashable, Sendable {
...
public struct NeuroionChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [NeuroionChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: NeuroionChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [NeuroionChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: NeuroionChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(NeuroionChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([NeuroionChatMessageContent].self, forKey: .content) {
...
public struct NeuroionChatHistoryPayload: Codable, Sendable {
...
public struct NeuroionSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct NeuroionSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [NeuroionSessionPreviewItem]
}

public struct NeuroionSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [NeuroionSessionPreviewEntry]

    public init(ts: Int, previews: [NeuroionSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct NeuroionChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct NeuroionChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct NeuroionAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct NeuroionChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct NeuroionGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct NeuroionPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: NeuroionPlatformImage?
...
public struct NeuroionChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
