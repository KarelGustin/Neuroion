...
public enum NeuroionCanvasA2UICommand: String, Codable, Sendable {
...
public struct NeuroionCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct NeuroionCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
