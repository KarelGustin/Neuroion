...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.neuroion", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.neuroion", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: NeuroionProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
