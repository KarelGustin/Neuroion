# 🦞 Neuroion — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/neuroion/neuroion/main/docs/assets/neuroion-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/neuroion/neuroion/main/docs/assets/neuroion-logo-text.png" alt="Neuroion" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/neuroion/neuroion/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/neuroion/neuroion/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/neuroion/neuroion/releases"><img src="https://img.shields.io/github/v/release/neuroion/neuroion?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/neuroion"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Neuroion** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://neuroion.ai) · [Docs](https://docs.neuroion.ai) · [DeepWiki](https://deepwiki.com/neuroion/neuroion) · [Getting Started](https://docs.neuroion.ai/start/getting-started) · [Updating](https://docs.neuroion.ai/install/updating) · [Showcase](https://docs.neuroion.ai/start/showcase) · [FAQ](https://docs.neuroion.ai/start/faq) · [Wizard](https://docs.neuroion.ai/start/wizard) · [Nix](https://github.com/neuroion/nix-neuroionbot) · [Docker](https://docs.neuroion.ai/install/docker) · [Discord](https://discord.gg/neuroion)

Preferred setup: run the onboarding wizard (`neuroion onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.neuroion.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.6** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.neuroion.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.neuroion.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.neuroion.ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.neuroion.ai/start/getting-started)

```bash
neuroion onboard --install-daemon

neuroion gateway --port 18789 --verbose

# Send a message
neuroion message send --to +1234567890 --message "Hello from Neuroion"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
neuroion agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.neuroion.ai/install/updating) (and run `neuroion doctor`).
...
Switch channels (git + npm): `neuroion update --channel stable|beta|dev`.
Details: [Development channels](https://docs.neuroion.ai/install/development-channels).
...
pnpm neuroion onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm neuroion ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `neuroion` binary.

## Security defaults (DM access)

Neuroion connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.neuroion.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `neuroion pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `neuroion doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.neuroion.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.neuroion.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.neuroion.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.neuroion.ai/nodes/voicewake) + [Talk Mode](https://docs.neuroion.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.neuroion.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.neuroion.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.neuroion.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.neuroion.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.neuroion.ai/nodes).
- **[Onboarding](https://docs.neuroion.ai/start/wizard) + [skills](https://docs.neuroion.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=neuroion/neuroion&type=date&legend=top-left)](https://www.star-history.com/#neuroion/neuroion&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.neuroion.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.neuroion.ai/web), and [Canvas host](https://docs.neuroion.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.neuroion.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.neuroion.ai/start/wizard), and [doctor](https://docs.neuroion.ai/gateway/doctor).
- [Pi agent runtime](https://docs.neuroion.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.neuroion.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.neuroion.ai/concepts/groups).
- [Media pipeline](https://docs.neuroion.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.neuroion.ai/nodes/audio).

### Channels

- [Channels](https://docs.neuroion.ai/channels): [WhatsApp](https://docs.neuroion.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.neuroion.ai/channels/telegram) (grammY), [Slack](https://docs.neuroion.ai/channels/slack) (Bolt), [Discord](https://docs.neuroion.ai/channels/discord) (discord.js), [Google Chat](https://docs.neuroion.ai/channels/googlechat) (Chat API), [Signal](https://docs.neuroion.ai/channels/signal) (signal-cli), [BlueBubbles](https://docs.neuroion.ai/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.neuroion.ai/channels/imessage) (legacy imsg), [Microsoft Teams](https://docs.neuroion.ai/channels/msteams) (extension), [Matrix](https://docs.neuroion.ai/channels/matrix) (extension), [Zalo](https://docs.neuroion.ai/channels/zalo) (extension), [Zalo Personal](https://docs.neuroion.ai/channels/zalouser) (extension), [WebChat](https://docs.neuroion.ai/web/webchat).
- [Group routing](https://docs.neuroion.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.neuroion.ai/channels).

### Apps + nodes

- [macOS app](https://docs.neuroion.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.neuroion.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.neuroion.ai/nodes/talk) overlay, [WebChat](https://docs.neuroion.ai/web/webchat), debug tools, [remote gateway](https://docs.neuroion.ai/gateway/remote) control.
- [iOS node](https://docs.neuroion.ai/platforms/ios): [Canvas](https://docs.neuroion.ai/platforms/mac/canvas), [Voice Wake](https://docs.neuroion.ai/nodes/voicewake), [Talk Mode](https://docs.neuroion.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.neuroion.ai/platforms/android): [Canvas](https://docs.neuroion.ai/platforms/mac/canvas), [Talk Mode](https://docs.neuroion.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.neuroion.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.neuroion.ai/tools/browser): dedicated neuroion Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.neuroion.ai/platforms/mac/canvas): [A2UI](https://docs.neuroion.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.neuroion.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.neuroion.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.neuroion.ai/automation/cron-jobs); [webhooks](https://docs.neuroion.ai/automation/webhook); [Gmail Pub/Sub](https://docs.neuroion.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.neuroion.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.neuroion.ai/concepts/channel-routing), [retry policy](https://docs.neuroion.ai/concepts/retry), and [streaming/chunking](https://docs.neuroion.ai/concepts/streaming).
- [Presence](https://docs.neuroion.ai/concepts/presence), [typing indicators](https://docs.neuroion.ai/concepts/typing-indicators), and [usage tracking](https://docs.neuroion.ai/concepts/usage-tracking).
- [Models](https://docs.neuroion.ai/concepts/models), [model failover](https://docs.neuroion.ai/concepts/model-failover), and [session pruning](https://docs.neuroion.ai/concepts/session-pruning).
- [Security](https://docs.neuroion.ai/gateway/security) and [troubleshooting](https://docs.neuroion.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.neuroion.ai/web) + [WebChat](https://docs.neuroion.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.neuroion.ai/gateway/tailscale) or [SSH tunnels](https://docs.neuroion.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.neuroion.ai/install/nix) for declarative config; [Docker](https://docs.neuroion.ai/install/docker)-based installs.
- [Doctor](https://docs.neuroion.ai/gateway/doctor) migrations, [logging](https://docs.neuroion.ai/logging).
...
- **[Gateway WebSocket network](https://docs.neuroion.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.neuroion.ai/gateway)).
- **[Tailscale exposure](https://docs.neuroion.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.neuroion.ai/gateway/remote)).
- **[Browser control](https://docs.neuroion.ai/tools/browser)** — neuroion‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.neuroion.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.neuroion.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.neuroion.ai/nodes/voicewake) + [Talk Mode](https://docs.neuroion.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.neuroion.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

Neuroion can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (Neuroion enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.neuroion.ai/gateway/tailscale) · [Web surfaces](https://docs.neuroion.ai/web)
...
Details: [Remote access](https://docs.neuroion.ai/gateway/remote) · [Nodes](https://docs.neuroion.ai/nodes) · [Security](https://docs.neuroion.ai/gateway/security)
...
Details: [Nodes](https://docs.neuroion.ai/nodes) · [macOS app](https://docs.neuroion.ai/platforms/macos) · [Gateway protocol](https://docs.neuroion.ai/concepts/architecture)
...
Details: [Session tools](https://docs.neuroion.ai/concepts/session-tool)

## Skills registry (NeuroionHub)

NeuroionHub is a minimal skill registry. With NeuroionHub enabled, the agent can search for skills automatically and pull in new ones as needed.

[NeuroionHub](https://neuroionhub.com)
...
- Controlled via `neuroion nodes …`.

Runbook: [iOS connect](https://docs.neuroion.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.neuroion.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.neuroion/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.neuroion/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.neuroion/neuroion.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.neuroion.ai/gateway/configuration)
...
Details: [Security guide](https://docs.neuroion.ai/gateway/security) · [Docker + sandboxing](https://docs.neuroion.ai/install/docker) · [Sandbox config](https://docs.neuroion.ai/gateway/configuration)

### [WhatsApp](https://docs.neuroion.ai/channels/whatsapp)

- Link the device: `pnpm neuroion channels login` (stores creds in `~/.neuroion/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.neuroion.ai/channels/telegram)
...
### [Slack](https://docs.neuroion.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.neuroion.ai/channels/discord)
...
### [Signal](https://docs.neuroion.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.neuroion.ai/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.neuroion.ai/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.neuroion.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.neuroion.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.neuroion.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.neuroion.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.neuroion.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.neuroion.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.neuroion.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.neuroion.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.neuroion.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.neuroion.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.neuroion.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.neuroion.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.neuroion.ai/platforms/windows), [Linux](https://docs.neuroion.ai/platforms/linux), [macOS](https://docs.neuroion.ai/platforms/macos), [iOS](https://docs.neuroion.ai/platforms/ios), [Android](https://docs.neuroion.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.neuroion.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.neuroion.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.neuroion.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.neuroion.ai/gateway/bonjour)
- [Gateway pairing](https://docs.neuroion.ai/gateway/pairing)
- [Remote gateway README](https://docs.neuroion.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.neuroion.ai/web/control-ui)
- [Dashboard](https://docs.neuroion.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.neuroion.ai/gateway/health)
- [Gateway lock](https://docs.neuroion.ai/gateway/gateway-lock)
- [Background process](https://docs.neuroion.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.neuroion.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.neuroion.ai/logging)

## Deep dives

- [Agent loop](https://docs.neuroion.ai/concepts/agent-loop)
- [Presence](https://docs.neuroion.ai/concepts/presence)
- [TypeBox schemas](https://docs.neuroion.ai/concepts/typebox)
- [RPC adapters](https://docs.neuroion.ai/reference/rpc)
- [Queue](https://docs.neuroion.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.neuroion.ai/tools/skills-config)
- [Default AGENTS](https://docs.neuroion.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.neuroion.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.neuroion.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.neuroion.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.neuroion.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.neuroion.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.neuroion.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.neuroion.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.neuroion.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.neuroion.ai/platforms/mac/voicewake)
- [iOS node](https://docs.neuroion.ai/platforms/ios)
- [Android node](https://docs.neuroion.ai/platforms/android)
- [Windows (WSL2)](https://docs.neuroion.ai/platforms/windows)
- [Linux app](https://docs.neuroion.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.neuroion.ai/gmail-pubsub](https://docs.neuroion.ai/automation/gmail-pubsub)

## Neuroion

Neuroion was built for **Neuroion**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [neuroion.ai](https://neuroion.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@neuroion](https://x.com/neuroion)
...
<p align="left">
  ...
  <a href="https://github.com/stephenchen2025"><img src="https://avatars.githubusercontent.com/u/218387130?v=4&s=48" width="48" height="48" alt="stephenchen2025" title="stephenchen2025"/></a> <a href="https://github.com/search?q=techboss"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="techboss" title="techboss"/></a> <a href="https://github.com/testingabc321"><img src="https://avatars.githubusercontent.com/u/8577388?v=4&s=48" width="48" height="48" alt="testingabc321" title="testingabc321"/></a> <a href="https://github.com/search?q=The%20Admiral"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="The Admiral" title="The Admiral"/></a> <a href="https://github.com/thesash"><img src="https://avatars.githubusercontent.com/u/1166151?v=4&s=48" width="48" height="48" alt="thesash" title="thesash"/></a> <a href="https://github.com/search?q=Vibe%20Kanban"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="Vibe Kanban" title="Vibe Kanban"/></a> <a href="https://github.com/voidserf"><img src="https://avatars.githubusercontent.com/u/477673?v=4&s=48" width="48" height="48" alt="voidserf" title="voidserf"/></a> <a href="https://github.com/search?q=Vultr-Neuroion%20Admin"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="Vultr-Neuroion Admin" title="Vultr-Neuroion Admin"/></a> <a href="https://github.com/search?q=Wimmie"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="Wimmie" title="Wimmie"/></a> <a href="https://github.com/search?q=wolfred"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="wolfred" title="wolfred"/></a>
