...
func NewPiTranslator(srcLang, tgtLang string, glossary []GlossaryEntry, thinking string) (*PiTranslator, error) {
	...
	options.AppName = "neuroion-docs-i18n"
	options.WorkDir = "/tmp"
...
- Keep product names in English: Neuroion, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Neuroion Gateway, use “Gateway 网关”.
