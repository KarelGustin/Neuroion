...
# Output:
# - dist/Neuroion.app
# - dist/Neuroion-<version>.zip
# - dist/Neuroion-<version>.dmg
...
APP="$ROOT_DIR/dist/Neuroion.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Neuroion-$VERSION.zip"
DMG="$ROOT_DIR/dist/Neuroion-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Neuroion-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Neuroion-$VERSION.dSYM.zip"
