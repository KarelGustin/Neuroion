...
show_usage() {
    cat << EOF
clawlog - Neuroion Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Neuroion logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Neuroion logs flow through the macOS unified log (subsystem: ai.neuroion).
