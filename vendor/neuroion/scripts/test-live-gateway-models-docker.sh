...
docker run --rm -t \
  ...
  -e NEUROION_LIVE_GATEWAY_MODELS="${NEUROION_LIVE_GATEWAY_MODELS:-${NEUROIONBOT_LIVE_GATEWAY_MODELS:-all}}" \
  -e NEUROION_LIVE_GATEWAY_PROVIDERS="${NEUROION_LIVE_GATEWAY_PROVIDERS:-${NEUROIONBOT_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e NEUROION_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${NEUROION_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${NEUROIONBOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
