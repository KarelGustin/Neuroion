...
if [[ -z "$version_content" ]]; then
  echo "<h2>Neuroion $VERSION</h2>"
  echo "<p>Latest Neuroion update.</p>"
  echo "<p><a href=\"https://github.com/neuroion/neuroion/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
